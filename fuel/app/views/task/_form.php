	...
	<fieldset>
		...
		<div class="form-group">
			<?php echo Form::label('Description', 'description', array('class'=>'control-label')); ?>
				...
				<?php echo Form::textarea('description', Input::post('description', isset($task) ? $task->description : ''), array('class' => 'col-md-8 form-control', 'rows' => 8, 'placeholder'=>'Description')); ?>
